    ...
    return(
        <section className="calidad">
            ...
            <div className="calidad__description">
                <p>Proporcionamos a nuestros pacientes y usuarios una excelente atenciónm calide,  oprtunidad y confiabilidad en nuestros reultados.</p><br />
                <a href="">Política de calidad</a>
            </div>
            <div className="calidad__imagen">
                <img src={calidad} alt="" />
            </div>
        </section>        
    )
